...
CREATE TABLE IF NOT EXISTS `mydb`.`Salariat` (
  ...
  `numeSalariat` VARCHAR(45) NULL,
  `dataNastere` VARCHAR(45) NULL,
  `salariu` INT NULL,
  `Departament_idDepartament` INT NOT NULL,
  PRIMARY KEY (`idSalariat`, `Departament_idDepartament`),
  INDEX `fk_Salariat_Departament1_idx` (`Departament_idDepartament` ASC),
  CONSTRAINT `fk_Salariat_Departament1`
